...
@ComponentScan(basePackages = {"np.com.mshrestha.uan"})
//@PropertySource("classpath:database.properties") //or set in PlaceSourceHolder method
public class RootConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws PropertyVetoException {
        ...
        em.setPackagesToScan("np.com.mshrestha.uan.model");
